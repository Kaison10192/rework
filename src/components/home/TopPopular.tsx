...
const UI_POS = {
  heading: { top: -88, left: 660 },
  tabs:    { top: -70, left: 930 },
  viewAll: { top: -45, left: -10 },
};
/* ==================================================== */
...
function RowScrollStrip({
  ...
  return (
    <>
      <div className="flex gap-3 overflow-x-auto snap-x snap-mandatory px-3 -mx-3 no-scrollbar">
        {items.map((it, idx) => (
          <article
            key={it.id}
...
/* ---------------- Main ---------------- */
export type TopPopularProps = {
  itemsComic?: Item[];
  itemsNovel?: Item[];
  initialItems?: Item[]; // <<< เพิ่มบรรทัดนี้
...
export default function TopPopular({
 ...
 const data = useMemo(() => {
  // ถ้ามี initialItems ให้ใช้เลย (โหมดส่งลิสต์เดียว)
  if (initialItems?.length) return initialItems;

  // ไม่งั้นดูตามแท็บ (ถ้าคุณส่งแยก)
  ...
  // mobile/tablet: ไม่มีเพจ แค่เปลี่ยนหมวด
    ...
    <>
      ...
      <section className="sm:hidden relative mx-auto max-w-[1320px] px-4 pt-4">
        <div className="origin-top transform-gpu scale-[0.95]">
          <h2 className="text-[40px] font-semibold font-heading ">10 อันดับยอดนิยม</h2>
          <div className="[-5px]">
      ...
      {/* ---------- TABLET (≥640px && <1024px) ---------- */}
      <section className="hidden sm:block lg:hidden relative mx-auto max-w-[1320px] px-5 pt-5">
        <div className="origin-top transform-gpu scale-[0.98]">
          <h2 className="text-[50px] font-semibold font-heading">10 อันดับยอดนิยม</h2>
      ...
      <section className="hidden lg:block relative mx-auto max-w-[1320px] px-6 pt-9">
        {/* กรอบมุม 4 ด้าน */}
        <img src="/มุมซ้ายบน.png"  alt="" className="absolute top-[0px] left-[-70px] w-[800px] z-30 pointer-events-none" />
        <img src="/มุมขวาบน.png"  alt="" className="absolute top-[-10px] right-[-67px] w-[260px] z-30 pointer-events-none" />
        <img src="/มุมซ้ายล่าง.png" alt="" className="absolute bottom-[-59px] left-[-67px] w-[220px] z-30 pointer-events-none" />
        <img src="/มุมขวาล่าง.png" alt="" className="absolute bottom-[-50px] right-[-100px] w-[600px] z-30 pointer-events-none" />
        ...
        <div className="relative z-10">
          <div className="mb-25 relative">
            ...
            {/* หัวข้อ */}
            <h2
              className="absolute text-[50px] font-semibold font-heading"
